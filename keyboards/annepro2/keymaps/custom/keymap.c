...
* |-----------------------------------------------------------------------------------------+
* | Ctrl  |  L1   |  Alt  |               FN1               |  Alt  |  FN1  |  FN2  | Ctrl  |
* \-----------------------------------------------------------------------------------------/
* Layer TAP in BASE
* ,-----------------------------------------------------------------------------------------.
* |     |     |     |     |     |     |     |     |     |     |     |     |     |           |
...
*/
 ...
 [BASE] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                    LT(FN1, KC_SPC),                            KC_RALT, _FN4_LF, _FN2_DW, _CTL_RG
),
  /*
  * Layer FN1
  * ,-----------------------------------------------------------------------------------------.
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    ...
    MO(FN2), _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_HOME,  KC_END, MO(FN3),
 ...
 [FN2] = LAYOUT_60_ansi( /* FN2 */
    ...
    _______, _______, _______,                            MO(FN1),                            _______, _______, _______, _______
 ),
  /*
  * Layer FN3
  * ,-----------------------------------------------------------------------------------------.
 ...
 [FN3] = LAYOUT_60_ansi( /* FN3 */
    ...
    MO(FN2), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MO(FN3),
    _______, _LED_ON, _LED_OF, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
    _______, _LED_PR, _LED_NE, _LED_IN, _LED_SP, _QKBOOT, _______, _______, _______, _______, _______,                   _______,
    _______, _______, _______,                            MO(FN1),                            _______, _______, _______, _______
 ),
  /*
  * Layer FN4
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    if (FN1 == layer) {
        ap2_led_sticky_set_key(4, 6, color_white);
    } else {
